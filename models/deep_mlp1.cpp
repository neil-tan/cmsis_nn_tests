...
}
{
    ...
    ctx.push(new FullyConnectedLayerCmsisOp<int>(),
              ...
              { "MatMul/eightbit:0" });
    ctx.eval();
    printf("FullyConnectedLayerCmsisOp1 done\r\n");
}
{
    ctx.add(new RamTensor<float>({0}), "MatMul/eightbit:1");
    ctx.add(new RamTensor<float>({1}), "MatMul/eightbit:2");
    printf("QuantRangeForMultiplicationOp start\r\n");
    ctx.push(new QuantRangeForMultiplicationOp<uint8_t, uint8_t, float>(),
    ...
    ctx.eval();
    printf("QuantRangeForMultiplicationOp done\r\n");
}
{
...
{
    ctx.add(new RamTensor<float>({0}), "MatMul_1/eightbit:1");
