...
}
{
    ...
    ctx.add(new RamTensor<float>({1}), "MatMul_eightbit/x__port__0/quantize:1", 2);
    ctx.add(new RamTensor<float>({1}), "MatMul_eightbit/x__port__0/quantize:2", 2);
...
{    
    ctx.add(new BinaryTensor<int>({2}, inline_MatMul_eightbit_x__port__0_quantize_newshape_0), 
            "MatMul_eightbit/x__port__0/quantize_newshape:0", 
            1);
}
{
    ctx.add(new RamTensor<uint8_t>(), "MatMul_eightbit/x__port__0/quantize:0_transpose", 1);
    ctx.push(new ReshapeOp(), 
             { "MatMul_eightbit/x__port__0/quantize:0", "MatMul_eightbit/x__port__0/quantize_newshape:0" },
             { "MatMul_eightbit/x__port__0/quantize:0_transpose" });
    ctx.eval();
}
{
    ctx.add(new RamTensor<int8_t>(), "MatMul_eightbit/x__port__0/quantize_q7:0", 2 + 1);
    ctx.push(new Uint8Q7OriginOp(),
             { "MatMul_eightbit/x__port__0/quantize:0_transpose", "MatMul_eightbit/x__port__0/quantize:1", "MatMul_eightbit/x__port__0/quantize:2" }, 
             { "MatMul_eightbit/x__port__0/quantize_q7:0" });
    ctx.eval();
}
{    
    ctx.add(new BinaryTensor<uint8_t>({128,784}, inline_Variable_quantized_const_0), 
...
{    
    ctx.add(new BinaryTensor<uint16_t>({1}, inline_cmsis_bShift_2_0), 
            "cmsis_bShift_2:0", 
            1);
}
{    
    ctx.add(new BinaryTensor<uint16_t>({1}, inline_cmsis_oShift_2_0), 
            "cmsis_oShift_2:0", 
            1);
}
{    
    ctx.add(new RamTensor<uint16_t>({1,784}), 
            "cmsis_scratch_2:0", 
            1);
}
{

    ctx.add(new RamTensor<int>(), "cmsis_fc_MatMul/eightbit:0", 1);
    ...
    ctx.push(new FullyConnectedLayerCmsisOp<int>(),
              ...
              { "cmsis_fc_MatMul/eightbit:0" });
    ctx.eval();
}
{    
    ctx.add(new BinaryTensor<int>({2}, inline_cmsis_fc_MatMul_eightbit_newshape_0), 
            "cmsis_fc_MatMul/eightbit_newshape:0", 
            1);
}
{
    ctx.add(new RamTensor<int>(), "MatMul/eightbit:0", 2 + 1);
    ctx.push(new ReshapeOp(), 
             { "cmsis_fc_MatMul/eightbit:0", "cmsis_fc_MatMul/eightbit_newshape:0" },
             { "MatMul/eightbit:0" });
    ctx.eval();
}
{
    ctx.add(new RamTensor<int>({1}), "MatMul/eightbit:1", 2);
    ctx.add(new RamTensor<int>({1}), "MatMul/eightbit:2", 2);
    
    ctx.push(new QuantRangeForMultiplicationOp<uint8_t, uint8_t, int>(),
              { "MatMul_eightbit/x__port__0/quantize:1", "MatMul_eightbit/x__port__0/quantize:2", "Variable_quantized_min:0", "Variable_quantized_max:0" },
              { "MatMul/eightbit:1", "MatMul/eightbit:2" });
    ctx.eval();
}
{
...
}
{
    ...
    ctx.add(new RamTensor<float>({1}), "Relu/eightbit:1", 2);
    ctx.add(new RamTensor<float>({1}), "Relu/eightbit:2", 2);
...
{    
    ctx.add(new BinaryTensor<int>({2}, inline_Relu_eightbit_newshape_0), 
            "Relu/eightbit_newshape:0", 
            1);
}
{
    ctx.add(new RamTensor<uint8_t>(), "Relu/eightbit:0_transpose", 1);
    ctx.push(new ReshapeOp(), 
             { "Relu/eightbit:0", "Relu/eightbit_newshape:0" },
             { "Relu/eightbit:0_transpose" });
    ctx.eval();
}
{
    ctx.add(new RamTensor<int8_t>(), "Relu/eightbit_q7:0", 2);
    ctx.push(new Uint8Q7OriginOp(),
             { "Relu/eightbit:0_transpose", "Relu/eightbit:1", "Relu/eightbit:2" }, 
             { "Relu/eightbit_q7:0" });
    ctx.eval();
}
{    
    ctx.add(new BinaryTensor<uint8_t>({64,128}, inline_Variable_2_quantized_const_0), 
...
{
    ctx.add(new RamTensor<int8_t>(), "Variable_2_quantized_const_q7:0", 1);
    ctx.push(new Uint8Q7OriginOp(),
             { "Variable_2_quantized_const:0", "Variable_2_quantized_min:0", "Variable_2_quantized_max:0" }, 
             { "Variable_2_quantized_const_q7:0" });
    ctx.eval();
}
{    
    ctx.add(new BinaryTensor<uint16_t>({1}, inline_cmsis_bShift_1_0), 
            "cmsis_bShift_1:0", 
            1);
}
{    
    ctx.add(new BinaryTensor<uint16_t>({1}, inline_cmsis_oShift_1_0), 
            "cmsis_oShift_1:0", 
            1);
}
{    
    ctx.add(new RamTensor<uint16_t>({1,128}), 
            "cmsis_scratch_1:0", 
            1);
}
{

    ctx.add(new RamTensor<int>(), "cmsis_fc_MatMul_1/eightbit:0", 1);
    
    ctx.push(new FullyConnectedLayerCmsisOp<int>(),
              { "Relu/eightbit_q7:0", "Variable_2_quantized_const_q7:0", "Relu/eightbit_q7:0", "cmsis_bShift_1:0", "cmsis_oShift_1:0", "cmsis_scratch_1:0" },
              { "cmsis_fc_MatMul_1/eightbit:0" });
    ctx.eval();
}
{    
    ctx.add(new BinaryTensor<int>({2}, inline_cmsis_fc_MatMul_1_eightbit_newshape_0), 
            "cmsis_fc_MatMul_1/eightbit_newshape:0", 
            1);
}
{
    ctx.add(new RamTensor<int>(), "MatMul_1/eightbit:0", 2);
    ctx.push(new ReshapeOp(), 
             { "cmsis_fc_MatMul_1/eightbit:0", "cmsis_fc_MatMul_1/eightbit_newshape:0" },
             { "MatMul_1/eightbit:0" });
    ctx.eval();
}
{
    ctx.add(new RamTensor<int>({1}), "MatMul_1/eightbit:1", 2);
    ctx.add(new RamTensor<int>({1}), "MatMul_1/eightbit:2", 2);
    
    ctx.push(new QuantRangeForMultiplicationOp<uint8_t, uint8_t, int>(),
              { "Relu/eightbit:1", "Relu/eightbit:2", "Variable_2_quantized_min:0", "Variable_2_quantized_max:0" },
              { "MatMul_1/eightbit:1", "MatMul_1/eightbit:2" });
    ctx.eval();
}
{
